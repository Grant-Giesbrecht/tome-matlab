...
%   conservative default for a format library), grafSave silently adapts
...
%   does not tolerate a missing dict_manifest key. grafLoad (this
    ...
    if warned
        warning('graf:save:octaveEmptyDictOmitted', ...
            ['Omitted one or more empty traces/surfaces/axes dicts because ' ...
             'Octave cannot write an empty HDF5 group. grafLoad restores ' ...

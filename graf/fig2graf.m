function g = fig2graf(fig)
%FIG2GRAF Extract a GrAF struct from a MATLAB figure handle.
%
%   g = fig2graf(fig)
%   g = fig2graf()          % uses gcf
%
%   Returns a struct compatible with writegraf/readgraf/graf2fig.
...
%   on throughout; writegraf/readgraf (the tome-backed serialization) work
%   identically on both platforms and are what to use from Octave. See
%   also savegraf, which goes straight from a figure to a .graf file in
%   one step.
